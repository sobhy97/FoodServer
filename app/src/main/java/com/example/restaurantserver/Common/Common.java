package com.example.restaurantserver.Common;
...
import com.example.restaurantserver.Retrofit.RetrofitClient;
...
public class Common {
    ...
    public static GeoCoordinate geoCoordinate() {
        return RetrofitClient.getClient(baseUrl).create(GeoCoordinate.class);
    }
